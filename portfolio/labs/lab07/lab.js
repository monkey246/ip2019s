...
function analyze() {
    ...
    do {
      ...
      var path = image.path(subs).fill('orange').stroke('blue').opacity(0.5).move(x-10, y-10).draggable();
      ...
      var circle2 = image.circle(30).fill('green').stroke('yellow').move(x-10, y-10).draggable();
      /*
